...
function firstSecondFetch(){
    if(main==1){
        fetch(`https://v6.exchangerate-api.com/v6/a875d285f4003afcc8b3e5cb/pair/${first}/${second}`).then(res => res.json()).then(data =>{
    ...
    fetch(`https://v6.exchangerate-api.com/v6/a875d285f4003afcc8b3e5cb/pair/${second}/${first}`).then(res => res.json()).then(data =>{
